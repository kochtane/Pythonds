...
user1_cert_path = 'C:\Certifictates\user1_certificate.pem'
user2_cert_path = 'C:\Certifictates\user2_certificate.pem'
ca_cert_path = 'C:\Certifictates\ca_certificate.pem'
